...
public class TriangleWindow extends javax.swing.JFrame {
    ...
    public TriangleWindow(NewJPanel canvas, JComboBox comboBox, Graphics g,JFrame j) {
        initComponents();
        this.setTitle("Triangle Properties");
        this.canvas = canvas;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Position3");

        positionX3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                positionX3ActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(positionX3, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(25, 25, 25)
                        .addComponent(jLabel10)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(positionY3, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(positionX3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(positionY3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void drawButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_drawButtonActionPerformed
        ...
        X3 = positionX3.getText();
        Y3 = positionY3.getText();
        ...
        if(!isInteger(X3)){
            positionX3.setText("invalid");
        }
        if(!isInteger(Y3)){
            positionY3.setText("invalid");
        }
        
        if (!isInteger(X1) || !isInteger(Y1) || !isInteger(X2) || !isInteger(Y2) || !isInteger(X3) || !isInteger(Y3)) {
...
//        }
        ...
        if (!is_Valid(p.distance(p2), p.distance(p3), p2.distance(p3))) {
            JOptionPane.showMessageDialog(null, "Points cannot form a triangle");
            return;
        }
        Triangle t = new Triangle(p, p2, p3);
        t.setColor(Color.BLACK);
        canvas.addShape(t);
        int tt = canvas.triangleCounter++;
        tt++;
        comboBox.addItem("Triangle "+ tt);
        canvas.refresh(g);
        j.setVisible(true);
        this.dispose();
    ...
    private void positionX3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_positionX3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_positionX3ActionPerformed
...
//            public void run() {
//                new TriangleWindow(null, null, null).setVisible(true);
//            }
//        });
//    }
